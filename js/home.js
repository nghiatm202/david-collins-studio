...
const backgroundShadowMouse = document.querySelectorAll('.post-details-mask-image, .home-content-hover')
...
function createPostElement(post) {
  ...
  homeContentLinkList.addEventListener('mouseover', (event) => {
    const image = homeContentLinkList.querySelector('img') || homeContentLinkList.querySelector('video')
